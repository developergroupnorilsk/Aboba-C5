...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st):
   ...
   if event == "30505-01.htm":
     return "30505-01.htm"

   if event == "30505-02.htm":
     return "30505-02.htm"

   if event == "30505-03.htm":
     return "30505-03.htm"

   if event == "30505-04.htm":
     return "30505-04.htm"

   if event == "30505-05.htm":
     return "30505-05.htm"

   if event == "30505-06.htm":
     return "30505-06.htm"

   if event == "30505-07.htm":
     return "30505-07.htm"

   if event == "30505-08.htm":
     return "30505-08.htm"

   if event == "class_change_45":
     if ClassId in [ClassId.orcFighter]:
        if Level <= 19 and st.getQuestItemsCount(MARK_OF_RAIDER_ID) == 0:
          htmltext = "30505-09.htm"
        if Level <= 19 and st.getQuestItemsCount(MARK_OF_RAIDER_ID) >= 1:
          htmltext = "30505-10.htm"
        if Level >= 20 and st.getQuestItemsCount(MARK_OF_RAIDER_ID) == 0:
          htmltext = "30505-11.htm"
...
QUEST   = Quest(30505,qn,"village_master")
...
QUEST.addStartNpc(30505)

QUEST.addTalkId(30505)
