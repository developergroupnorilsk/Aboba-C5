...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st):
   ...
   if event == "30288-01.htm":
     return "30288-01.htm"

   if event == "30288-02.htm":
     return "30288-02.htm"

   if event == "30288-03.htm":
     return "30288-03.htm"

   if event == "30288-04.htm":
     return "30288-04.htm"

   if event == "30288-05.htm":
     return "30288-05.htm"

   if event == "30288-06.htm":
     return "30288-06.htm"

   if event == "30288-07.htm":
     return "30288-07.htm"

   if event == "30288-08.htm":
     return "30288-08.htm"

   if event == "30288-09.htm":
     return "30288-09.htm"

   if event == "30288-10.htm":
     return "30288-10.htm"

   if event == "30288-11.htm":
     return "30288-11.htm"

   if event == "30288-12.htm":
     return "30288-12.htm"

   if event == "30288-13.htm":
     return "30288-13.htm"

   if event == "30288-14.htm":
     return "30288-14.htm"

   if event == "30288-15.htm":
     return "30288-15.htm"

   if event == "30288-16.htm":
     return "30288-16.htm"

   if event == "30288-17.htm":
     return "30288-17.htm"

   if event == "class_change_19":
     if ClassId in [ClassId.elvenFighter]:
        if Level <= 19 and st.getQuestItemsCount(ELVEN_KNIGHT_BROOCH_ID) == 0:
          htmltext = "30288-18.htm"
        if Level <= 19 and st.getQuestItemsCount(ELVEN_KNIGHT_BROOCH_ID) >= 1:
          htmltext = "30288-19.htm"
